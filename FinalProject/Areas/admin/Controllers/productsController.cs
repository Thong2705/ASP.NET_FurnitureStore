...
namespace FinalProject.Areas.admin.Controllers
{
    public class productsController : BaseController
    {
        ...
        [ValidateInput(false)]
        public ActionResult Create([Bind(Include = "id,name,price,img,description,meta,size,color,hide,order,datebegin,categoryid")] product product, [Bind(Include = "id,img,order,productid")] image_product image_Product,
